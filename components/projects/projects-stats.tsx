...
import { FolderOpen, Play, CheckCircle, DollarSign } from "lucide-react"
...
export function ProjectsStats({ totalProjects, activeProjects, completedProjects, totalBudget }: ProjectsStatsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-emerald-600">${totalBudget.toLocaleString()}</div>
